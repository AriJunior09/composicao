...
public class Program01 {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println();
		System.out.print("Entre com o mês e o ano que deseja consutar a renda (MM/AAAA): ");
		...
		System.out.println("Renda para: " + mes_e_ano + ": " + String.format("%.2f", trabalhador.renda(ano, mes)));
